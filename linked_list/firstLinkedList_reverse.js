class LinkedList {
    ...
    reverse() {
        ...
        while (current) {
            // save pointer value for next node from current node
            let save = current.next;

            // reverse pointer; specify next node with previous node
            current.next = previous;

            // specify previous node to current node
            previous = current;

            // specify current node to next node or null at end of list
            current = save;
